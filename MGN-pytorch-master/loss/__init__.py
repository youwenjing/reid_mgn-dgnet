...
from loss.triplet import TripletLoss, TripletSemihardLoss, CenterLoss
...
class Loss(nn.modules.loss._Loss):
    def __init__(self, args, ckpt):
        ...
        for loss in args.loss.split('+'):   #解析输入端的loss function
        ...
        for l in self.loss:     #打印loss function
    ...
    def forward(self, outputs, labels): #loss权值加和
        losses = []
