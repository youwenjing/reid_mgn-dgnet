...
class MGN(nn.Module):
    ...
    def forward(self, x):
        ...
        f3_p3 = self.reduction_8(z3_p3).squeeze(dim=3).squeeze(dim=2)
        ...
        predict = torch.cat([fg_p1, fg_p2, fg_p3, f0_p2, f1_p2, f0_p3, f1_p3, f2_p3, f3_p3], dim=1)

        return predict, fg_p1, fg_p2, fg_p3, l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3, l3_p3
